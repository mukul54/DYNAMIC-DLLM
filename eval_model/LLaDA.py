...
class LLaDA(TemplateLM):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if is_feature_cache:
            DynamicDLLMCache.new_instance(**asdict(DynamicDLLMCacheConfig(
        ...
        if self.rank == 0:
                print(f"Feature Cache is {is_feature_cache}.CFG Cache is {is_cfg_cache},prompt_interval_steps={prompt_interval_steps}, gen_interval_steps={gen_interval_steps}, cfg_interval_steps={cfg_interval_steps},window_size={window_size},layer_budget={layer_budget},select_from={select_from},generate_mode={generate_mode},pd_mode={pd_mode},pd_threshold={pd_threshold},pd_alpha={pd_alpha},pd_beta={pd_beta}")
